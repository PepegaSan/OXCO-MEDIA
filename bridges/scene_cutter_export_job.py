#!/usr/bin/env python3
"""Hail Mary Bridge: Mehrere Szenen exportieren (vendored cutter FFmpeg-Logik)."""
...
from ffmpeg_export import export_scenes  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--no-safe-output", action="store_false", dest="safe_output")
    ...
    out = None
    try:
        out = export_scenes(src, scenes, args.codec, out_dir, log=emit, safe_output=args.safe_output)
